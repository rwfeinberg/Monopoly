...
/**
 * The purpose of this class is to deduct a certain amount from a player and provide
 * a relevant String for a user-facing popup.
 * @author wyattfocht
 */
public class HospitalFee extends Action {
   ...
   * @param resourcesPath
   */
  public HospitalFee(int firstInt, int secondInt, List<Player> players,
