 ...
 * @author wyattfocht
 */
public class RepairsOnProperties extends Action {
   ...
   * @param resourcesPath
   */
  public RepairsOnProperties(int firstInt, int secondInt, List<Player> players,
  ...
  public boolean performAction() {
    int total = getCurrentPlayer().getHouseCount() * getFirstInt()
        + getCurrentPlayer().getHotelCount() * getSecondInt();
    if (playerCanPay(total)) {
      editPlayerWealth(getCurrentPlayer().getHouseCount() * getFirstInt(), -1);
      editPlayerWealth(getCurrentPlayer().getHotelCount() * getSecondInt(), -1);
    }
  ...
  public String toString() {
    return (getStringForPopup(this.getClass().getSimpleName() + "Front") + getFirstInt()
        + getStringForPopup(this.getClass().getSimpleName() + "Back") + getSecondInt());
  }
