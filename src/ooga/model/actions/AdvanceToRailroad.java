...
/**
 * The purpose of this class is to advance a player to a Railroad tile and provide
...
public class AdvanceToRailroad extends Action {
   ...
   * @param resourcesPath
   */
  public AdvanceToRailroad(int firstInt, int secondInt, List<Player> players,
  ...
  public boolean performAction() {
    movePlayerToFirstInstanceOf("Railroad");
