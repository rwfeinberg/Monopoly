...
/**
 * The purpose of this class is to allow a player the future ability to get out of jail and provide
 * a relevant String for a user-facing popup.
 * @author wyattfocht
 */
public class GetOutOfJail extends Action {
   ...
   * @param resourcesPath
   */
  public GetOutOfJail(int firstInt, int secondInt, List<Player> players,
  ...
  public boolean performAction() {
    getCurrentPlayer().setGetOutOfJail(true);
