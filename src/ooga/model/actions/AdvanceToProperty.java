...
/**
 * The purpose of this class is to advance a player to a Property tile and provide
 * a relevant String for a user-facing popup.
 * @author wyattfocht
 */
public class AdvanceToProperty extends Action {

  private static final int FEW_STEPS_FORWARD = 10;
   ...
   * @param resourcesPath
   */
  public AdvanceToProperty(int firstInt, int secondInt, List<Player> players,
  ...
  public boolean performAction() {
    //move player a few steps forward
    movePlayerGivenSteps(FEW_STEPS_FORWARD);
    movePlayerToFirstInstanceOf("Property");
  ...
  public String toString() {
    return (getStringForPopup(this.getClass().getSimpleName()) + getCurrentPlayer().getLocation()
        .getName());
  }
}
