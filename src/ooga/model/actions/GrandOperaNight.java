...
/**
 * The purpose of this class is to deduct a certain amount from each player besides the current
 * player, add the total amount deducted to the current player, and provide
 * a relevant String for a user-facing popup.
 * @author wyattfocht
 */
public class GrandOperaNight extends Action {
   ...
   * @param resourcesPath
   */
  public GrandOperaNight(int firstInt, int secondInt, List<Player> players,
