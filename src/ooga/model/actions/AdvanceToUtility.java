...
/**
 * The purpose of this class is to advance a player to a Utility tile and provide
...
public class AdvanceToUtility extends Action {
   ...
   * @param resourcesPath
   */
  public AdvanceToUtility(int firstInt, int secondInt, List<Player> players,
  ...
  public boolean performAction() {
    movePlayerToFirstInstanceOf("UtilityTile");
