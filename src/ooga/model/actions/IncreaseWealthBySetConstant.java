...
/**
 * The purpose of this class is to increase the wealth of a player by a hard-coded amount (for cheat
 * key)
 * @author wyattfocht
 */
public class IncreaseWealthBySetConstant extends Action {
   ...
   * @param resourcesPath
   */
  public IncreaseWealthBySetConstant(int firstInt, int secondInt,
      List<Player> players,
